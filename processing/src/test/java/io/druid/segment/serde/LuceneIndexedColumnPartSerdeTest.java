...
/**
 */
public class LuceneIndexedColumnPartSerdeTest
{
  @Test
  public void testSerde() throws Exception
  {
    ...
    LuceneIndexedColumnPartSerde serde = (LuceneIndexedColumnPartSerde) mapper.readValue(
    ...
    serde = (LuceneIndexedColumnPartSerde) mapper.readValue(
        mapper.writeValueAsString(
            mapper.readValue(json, ColumnPartSerde.class)
        ),
        ColumnPartSerde.class
