...
/**
 */
class LuceneColumn extends SimpleColumn
{
  private final Supplier<LuceneIndexEncodedColumn> luceneIndexEncodedColumn;

  LuceneColumn(
      ColumnCapabilities capabilities,
      Supplier<DictionaryEncodedColumn> dictionaryEncodedColumn,
      Supplier<LuceneIndexEncodedColumn> luceneIndexEncodedColumn,
  ...
  {
    super(capabilities, dictionaryEncodedColumn, runLengthColumn, genericColumn,
        complexColumn, bitmapIndex, spatialIndex);
    this.luceneIndexEncodedColumn = luceneIndexEncodedColumn;
  }

  @Override public LuceneIndexEncodedColumn getLuceneIndexEncoding()
  {
    return luceneIndexEncodedColumn == null ? null : luceneIndexEncodedColumn.get();
  }
}
