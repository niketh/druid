...
/**
*/
public class LuceneIndexedColumnSupplier implements Supplier<DictionaryEncodedColumn>
{
  ...
  public LuceneIndexedColumnSupplier(
  ...
  @Override
  public LuceneIndexEncodedColumn get()
  {
    return new LuceneIndexEncodedColumn(
